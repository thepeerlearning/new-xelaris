...
export function Hero() {
  return (
    <div className="flex flex-col items-center justify-center pt-20 lg:pt-28 py-5 px-4 w-full max-w-360 mx-auto">
      {/* Main Heading */}
      <div className="flex flex-col items-center w-full">
        <h1 className="font-medium text-center  text-4xl md:text-5xl lg:text-[5rem] leading-[100%] lg:leading-24 lg:tracking-[-4.5px]  md:px-0 text-white">
          For Ambitious Kids <br className="block lg:hidden" /> Who{" "}
          <br className="hidden lg:block" /> Want to Build,{" "}
          <br className="block lg:hidden" /> Not Just Learn
        </h1>
      </div>

      {/* Description */}
      <div className="h-auto relative w-full max-w-180 mt-6">
