            ...
            <div className="relative w-full">
              ...
              {openSections.has('programs') && (
                <div className="flex flex-col gap-4 items-start pt-4 pb-2 w-full">
                  <Link href="/programs/foundation" className="opacity-70 hover:opacity-100 transition-opacity">
                    <span className="font-normal text-white text-lg">Foundation</span>
                  </Link>
                  <Link href="/programs/intermediate" className="opacity-70 hover:opacity-100 transition-opacity">
                    <span className="font-normal text-white text-lg">Intermediate</span>
                  </Link>
                  <Link href="" className="opacity-70 hover:opacity-100 transition-opacity">
                    <span className="font-normal text-white text-lg">Advanced</span>
                  </Link>
                  <Link href="/programs/ai-for-high-school" className="opacity-70 hover:opacity-100 transition-opacity">
                    <span className="font-medium text-white text-lg tracking-[-1px] leading-6">AI (High School)</span>
                  </Link>
                  <Link href="/programs/web3-for-high-school" className="opacity-70 hover:opacity-100 transition-opacity">
                    <span className="font-normal text-white text-lg">Web3 (High School)</span>
                  </Link>
                </div>
              )}
            </div>
              ...
              {openSections.has('company') && (
                <div className="flex flex-col gap-4 items-start pt-4 pb-2 w-full">
                  <Link href="/about" className="opacity-70 hover:opacity-100 transition-opacity">
                    <span className="font-normal text-white text-lg">About</span>
                  </Link>
                  <Link href="/contact" className="opacity-70 hover:opacity-100 transition-opacity">
                    <span className="font-normal text-white text-lg">Contact</span>
                  </Link>
                  <Link href="/pricing" className="opacity-70 hover:opacity-100 transition-opacity">
                    <span className="font-normal text-white text-lg">Pricing</span>
                  </Link>
                </div>
              )}
            </div>
              ...
              {openSections.has('legal') && (
                <div className="flex flex-col gap-4 items-start pt-4 pb-2 w-full">
                  <Link href="/terms" className="opacity-70 hover:opacity-100 transition-opacity">
                    <span className="font-normal text-white text-lg">Terms of Service</span>
                  </Link>
                  <Link href="/privacy" className="opacity-70 hover:opacity-100 transition-opacity">
                    <span className="font-normal text-white text-lg">Privacy Policy</span>
                  </Link>
                </div>
              )}
            </div>
...
<path d="M7.58126 25.0611V13.6481H11.0375L11.5513 9.17964H7.58126V6.33335C7.58126 5.0439 7.90376 4.16105 9.56496 4.16105H11.67V0.177085C10.6458 0.0548148 9.61626 -0.00422505 8.58626 0.000234952C5.53126 0.000234952 3.43376 2.07785 3.43376 5.89194V9.17124H0V13.6398H3.44126V25.0611H7.58126Z" fill="white"/>
</svg>
...
<path d="M22.0412 5.53941C22.0575 5.78311 22.0575 6.02541 22.0575 6.26771C22.0575 13.6828 16.9912 22.2272 7.7325 22.2272C4.88 22.2272 2.23 21.3067 0 19.7081C0.405 19.7596 0.795 19.7777 1.21625 19.7777C3.48249 19.7838 5.68456 18.9397 7.4675 17.3812C6.41678 17.3601 5.39822 16.9739 4.55405 16.2766C3.70987 15.5794 3.08223 14.6058 2.75875 13.492C3.07 13.5435 3.3825 13.5783 3.71 13.5783C4.16125 13.5783 4.615 13.5087 5.03625 13.3875C3.89595 13.1311 2.87059 12.4425 2.13452 11.439C1.39845 10.4355 0.99712 9.17891 0.99875 7.88301V7.81331C1.67 8.22971 2.44875 8.49011 3.27375 8.52491C2.58261 8.01331 2.0159 7.31901 1.62417 6.50411C1.23245 5.68921 1.02789 4.77891 1.02875 3.85446C1.02875 2.81286 1.2775 1.8576 1.71375 1.02489C2.97892 2.75858 4.55688 4.17691 6.34542 5.18801C8.134 6.19911 10.0932 6.78041 12.0962 6.89431C12.0187 6.47651 11.9712 6.04351 11.9712 5.60901C11.9709 4.87231 12.1009 4.14279 12.3538 3.4621C12.6068 2.78142 12.9776 2.16295 13.4452 1.64203C13.9128 1.12111 14.468 0.707971 15.079 0.426221C15.6901 0.144471 16.3449 -0.000359331 17.0062 6.69484e-07C18.4562 6.69484e-07 19.765 0.676761 20.685 1.77127C21.8122 1.52844 22.8932 1.07003 23.88 0.416361C23.5043 1.71253 22.7172 2.81162 21.6662 3.50772C22.666 3.3807 23.643 3.08782 24.565 2.6388C23.8764 3.75712 23.0231 4.73781 22.0412 5.53941Z" fill="white"/>
          ...
          <div className="border-t-2 border-white flex flex-col gap-2 items-start py-5 px-0 w-full">
            ...
            <div className="grid grid-cols-5 gap-4 w-full max-w-[250px]">
              {countryCodes.slice(0, 20).map((code, index) => (
                ...
                >
                  <Flag code={code} className="w-full h-full object-cover rounded-[0.3125rem]" />
                </div>
              ))}
            </div>
          </div>
        ...
        {/* Desktop Menu Layout */}
        <div className="hidden max-w-7xl xl:max-w-[90rem] 2xl:max-w-[1440px] mx-auto lg:flex items-start justify-between max-w-5xl xl:max-w-6xl 2xl:max-w-[1224px] w-full mx-auto">
          ...
          <div className="hidden lg:flex flex-col items-start leading-normal text-lg w-full">
            <div className="flex flex-col font-bold justify-center text-white w-full max-w-[610px]">
              <p className="leading-normal whitespace-normal">
                XELARIS:<span className="font-normal"> For Ambitious Kids/Teens Who Want to Build, Not Just Learn</span>
              </p>
            </div>
            <div className="flex flex-col font-normal justify-center text-[#b0b0b0]">
              <p className="leading-[22px] whitespace-nowrap">We saw a disconnect in how kids were learning tech skills. Most coding programs teach students to replicate pre-built projects and follow instructions,</p>
            </div>
            <div className="flex flex-col font-normal justify-center text-[#b0b0b0]">
              <p className="leading-[22px] whitespace-nowrap">led by instructors who&apos;ve never shipped code to production. Pre-built curriculums where everyone makes the same thing. Students complete courses,</p>
            </div>
            <div className="flex flex-col font-normal justify-center text-[#b0b0b0]">
              <p className="leading-[22px] whitespace-nowrap">earn certificates, and graduate without ever building something real. So we built what we wished existed: true 1-on-1 mentorship with engineers who work</p>
            </div>
            <div className="flex flex-col font-normal justify-center text-[#b0b0b0]">
              <p className="leading-[22px] whitespace-nowrap">
                in the industry. No cohorts. No fixed curriculum. Just a student with an idea working with an engineer. <span className="font-bold">All programs is developed and taught</span>
              </p>
            </div>
