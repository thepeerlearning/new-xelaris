            ...
            <div className="bg-[#1c2026] flex flex-col p-2 rounded-tl-[32px] rounded-tr-[32px] rounded-bl-[20px] rounded-br-[20px] w-full">
              ...
              <div className="bg-[#12161c] flex flex-col gap-6 p-4 rounded-[24px]">
                ...
                <div className="flex items-center justify-center overflow-hidden p-px rounded-[24px] bg-gradient-to-br from-white via-white/10 to-white/0 w-full">
                  <div
                    className="backdrop-blur-sm flex items-center justify-center px-3 py-1.5 rounded-[24px] shadow-[0px_4px_4px_0px_#fefc00] bg-gradient-to-br from-[#2c2e31] to-[#1e2024] w-full"
                  >
                    <p className={`font-medium leading-5 text-white text-lg sm:text-xl tracking-tight text-center ${selectedProgram === 'foundation' ? 'whitespace-pre-line' : 'whitespace-nowrap'}`}>
                      {tier.sessionType}
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-center w-full mt-auto">
                ...
                >
                  <span className="font-medium text-[#161a20] text-lg leading-6 tracking-[-0.4px] text-center">
                    {selectedProgram === 'advanced' ? 'Book A Trial Class →' : 'Enroll Now →'}
                  </span>
                </a>
              </div>
            </div>
              ...
              <div className="bg-[#12161c] flex flex-col gap-6 p-4 rounded-[24px]">
                ...
                <div className="flex items-center justify-center overflow-hidden p-px rounded-[24px] bg-gradient-to-br from-white via-white/10 to-white/0 w-full">
                  <div
                    className="backdrop-blur-sm flex items-center justify-center px-3 py-1.5 rounded-[24px] shadow-[0px_4px_4px_0px_#fefc00] bg-gradient-to-br from-[#2c2e31] to-[#1e2024] w-full"
                  >
                    <p className={`font-medium leading-5 text-white text-lg tracking-tight text-center ${selectedProgram === 'foundation' ? 'whitespace-pre-line' : 'whitespace-nowrap'}`}>
                      {tier.sessionType}
                    </p>
                  </div>
                </div>
