    ...
    <div className="bg-white bg-no-repeat bg-top bg-fixed relative flex flex-col items-center min-h-[100vh] overflow-hidden place-content-center">
      <div className="bg-top bg-no-repeat max-w-[768px] flex flex-col justify-center items-center bg-white">
        <Button className="w-fit h-[48px] flex gap-[2px] justify-center items-center py-[12px] px-[18px] rounded-lg border border-solid border-[#D0D5DD] bg-white shadow-[0px_1px_2px_0px_rgba(16, 24, 40, 0.05)] cursor-pointer">
          ...
          <p className="p-0 m-0 text-white font-semibold -font-grotesk text-[16px]/[20px]">
            401 error
          </p>
        </Button>
        <h1 className="w-full flex text-center flex-col text-white m-0 font-bold -font-grotesk text-2xl sm:text-[40px]/[60px] -tracking-[0.02em]">
          You&apos;re not authorize to view this page
          <span className="text-center text-white m-0 font-normal -font-grotesk text-[20px]/[30px]">
        ...
        <div className="w-full flex flex-col sm:flex-row gap-4 justify-center items-center mt-[32px]">
          <div
            className="w-full md:w-[150px] h-[48px] flex justify-center items-center py-[12px] px-[18px] rounded-lg border border-solid border-[#D0D5DD] bg-primary text-[#1d1f24] shadow-[0px_1px_2px_0px_rgba(16, 24, 40, 0.05)] cursor-pointer font-semibold -font-grotesk text-[18px]/[28px]"
            onClick={() => router.push("/")}
          >
            Go home
          </div>
