        ...
        return (
          ...
          >
            <div className="flex items-center">
              ...
              >
                <span className="text-[14px]/[18px] -font-grotesk font-medium tracking-normal">
                  {stepNumber}
                </span>
              </div>
            ...
            {/* Step title */}
            <p
              className={`w-full -font-grotesk font-medium tracking-normal text-[13.67px]/[18px] text-white/83}`}
            >
              {stepTitles[index]}
            </p>
          </div>
