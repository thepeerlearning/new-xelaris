    ...
    >
      <div className="w-full flex gap-2">
        <div className="w-2/3 relative flex flex-col gap-1">
          <label
            className="text-secondary text-sm font-normal -font-grotesk tracking-[0.6000000238418579px] text-left disabled:text-[#98A2B3]"
            htmlFor="expiry"
          >
            Card number
          </label>
      ...
      {message && (
        <div
          id="payment-message"
          className="font-normal -font-grotesk text-center text-sm text-primary -tracking-[1.2px] my-5"
        >
          {message}
        </div>
      )}
