...
export const personalInfoSchema = z.object({
  ...
  country: z
    .string()
    .min(1, "Please select your country code from the dropdown"),

  phoneNumber: z
    .string()
    .min(1, "Please enter your phone number")
    .min(6, "Phone number is too short (minimum 6 digits)")
      ...
      <Form {...form}>
        ...
        >
          ...
          <div className="w-full mt-6 mb-2">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="relative w-8 h-8 rounded-full overflow-hidden border-2 border-gray-200">
                <Image
                  src={previewUrl || "/avatar-placeholder.webp"}
                  alt="Profile picture"
                  fill
          ...
          <Button
            ...
            className="w-full h-[46px] py-[9px] px-[13px] flex gap-1 -font-grotesk font-normal text-black text-[17px]/[24px] tracking-normal mt-6 disabled:text-black"
          >
