...
export default function HomePage() {
  ...
  return (
    <div className="w-full max-w-[460px] flex flex-col gap-4">
      <h4 className="font-normal -font-grotesk text-[16px]/[24px] sm:text-[17px]/[26px] text-white tracking-normal">
        Enrolled kids
      </h4>
      ...
      {loading ? (
        ...
        data?.map((child: any) => (
          <div
            key={child.id}
            className="w-full rounded border border-dashed border-[#252C32]/60 hover:border-[#252C32] transition-colors text-white"
          >
            <div className="flex flex-col gap-2 p-4 sm:p-6">
              <h4 className="font-normal -font-grotesk text-[16px]/[24px] sm:text-[17px]/[26px] text-white tracking-normal">
                {`${child.name} - username: ${child.username ?? ""}`}
              </h4>
              <p className="font-normal -font-grotesk text-[14px]/[22px] sm:text-[16px]/[26px] text-white tracking-normal">
