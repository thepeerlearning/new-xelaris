  ...
  return (
    <div className="w-full px-4 sm:px-6 md:px-8 lg:px-[64px] flex flex-col gap-8 md:gap-12">
      ...
      <div className="w-full flex flex-col gap-1 py-4">
        <h2 className="-font-grotesk font-normal text-[16px]/[22px] sm:text-[18px]/[24px] -tracking-[1.4%] text-secondary">
          Welcome
        </h2>
        <h4 className="-font-grotesk font-normal text-[28px]/[36px] sm:text-[32px]/[42px] md:text-[36px]/[48px] -tracking-[2.2%] text-white capitalize">
          {displayName}
        </h4>
        <p className="-font-grotesk font-normal text-[14px]/[20px] sm:text-[15px]/[24px] -tracking-[0.6%] text-white">
          ...
          <div className="min-w-max flex gap-4 sm:gap-[32px] pb-1">
            {steps?.map((item, index) => (
              <button
                type="button"
                key={item}
                className={`-font-grotesk font-normal text-[14px]/[24px] -tracking-[0.6%] pb-2 transition-colors ${
                  activeTab === index + 1
