  ...
  return (
    <div className="w-full flex flex-col gap-8 bg-[#1D1F24]">
      ...
      <div className="w-full px-6 bg-[#1D1F24]">
        <h4 className="w-full flex gap-2 font-bold -font-grotesk text-lg text-secondary">
          All Students{" "}
          <span className="w-[25px] h-[25px] flex justify-center items-center p-[2px] mt-1 rounded-md border border-solid border-[#E5E9EB]/20 font-normal -font-grotesk text-xs/[18px] ">
            {count ? count : 0}
          </span>
        </h4>
      </div>
              ...
              {loading ? (
                ...
                <>
                  <CardHeader className="py-3 px-6 m-0">
                    <h4 className="w-full font-medium -font-grotesk text-sm text-secondary">
                      Student Name
                    </h4>
                  </CardHeader>
                            ...
                            >
                              <Avatar className="w-8 h-8">
                                <AvatarImage
                                  ...
                                  alt="Student photo"
                                />
                                <AvatarFallback className="bg-[#F2F4F7] text-[#667085] font-medium -font-grotesk text-sm">
                              ...
                              <div className="flex-1 space-y-1">
                                <p
                                  className={
                                    contact?.id === student.id
                                      ? "text-white font-medium -font-grotesk text-sm capitalize"
                                      : "text-secondary font-normal -font-grotesk text-sm capitalize"
                                  }
                                >
                                ...
                                <p
                                  className={
                                    contact?.id === student.id
                                      ? "text-white font-normal -font-grotesk text-sm capitalize"
                                      : "text-secondary font-normal -font-grotesk text-sm capitalize"
                                  }
                                >
                              ...
                              <Button
                                ...
                                className={
                                  contact?.id === student.id
                                    ? "w-[100px] mt-2 mr-1 bg-primary h-[40px] flex justify-center items-center py-[2px] px-[6px] border border-solid border-primary hover:text-white text-black -font-grotesk font-bold text-xs/[18px] cursor-pointer rounded-full"
                                    : "w-[100px] bg-transparent h-[40px] flex justify-center items-center py-[2px] px-[6px] border border-solid border-primary text-primary -font-grotesk font-bold text-xs/[18px] cursor-pointer rounded-full hover:bg-primary/10"
                                }
                              >
                                View class
                              </Button>
                  ...
                  <div className="w-full flex flex-col justify-center items-center py-[20px]] mt-8 md:mt-6 xl:mt-8">
                    <div className="flex justify-end items-center gap-4">
                      <Button
                        type="button"
                        className="w-[100px] h-[36px] py-4 px-[19px] normal-case font-bold -font-grotesk text-[14px]/[20.3px] text-black bg-white hover:bg-white/90 rounded-lg border border-solid border-[#D0D5DD] shadow-[0px_1px_2px_0px_#1018280D] disabled:cursor-not-allowed"
            ...
            <div className="w-full flex flex-col gap-4">
              <div className="w-full bg-[#1D1F24]">
                <div className="w-full h-[188px] p-6 flex flex-col flex-start gap-2 bg-[#1D1F24] rounded-xl">
                  <h4 className="w-full flex text-white font-bold -font-grotesk text-lg m-0 p-0">
                    Parent information
                  </h4>
                  <p className="w-full flex p-0 m-0 taxt-white gap-1 font-bold -font-grotesk text-[16px]/[20px]">
                    Full name:{" "}
                    <span className="text-white font-normal -font-grotesk text-sm">
                      {contact?.parent?.name}
                    </span>
                  </p>
                  <p className="w-full flex p-0 m-0 taxt-white gap-1 font-bold -font-grotesk text-[16px]/[20px]">
              ...
              <div className="w-full flex flex-col gap-1 bg-[#1D1F24] p-6 rounded-xl min-h-[123px]">
                <h4 className="w-full flex text-white font-medium -font-grotesk text-lg m-0 p-0">
                  Class Schedule
                </h4>
                {!isEmpty(contact?.class?.schedules) ? (
                  contact?.class?.schedules.map((clx: any, index: number) => {
                    ...
                    return (
                      ...
                      >
                        <p className="w-full flex p-0 m-0 taxt-white gap-1 font-bold -font-grotesk text-[16px]/[20px] capitalize">
                          Day:{" "}
                          <span className="text-white font-normal -font-grotesk text-sm">
                            {clx.day}
                          </span>
                        ...
                        <div className="w-full flex justify-end items-center">
                          <Link
                            ...
                            target="_blank"
                            className="w-fit h-[36px] py-4 px-[22px] normal-case font-bold -font-grotesk text-[14px]/[20.3px] text-black bg-primary hover:bg-primary/90 hover:scale-[1.008] transition duration-300 ease-in-out rounded-lg flex justify-center items-center"
                          >
                            Join Class
                          </Link>
                        </div>
              ...
              <div className="w-full flex flex-col gap-1 bg-[#1D1F24] pt-6 pb-0 px-6 rounded-xl">
                <h4 className="w-full flex text-error font-bold -font-grotesk text-lg m-0 p-0">
                  Danger Zone
                </h4>
                <div className="w-full flex justify-end items-center">
