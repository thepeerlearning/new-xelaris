  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="bg-[#D3D3D6] border border-solid border-[#D3D3D6] rounded-[4px] px-6 h-[48px] w-[200px] flex justify-center items-center gap-2 text-sm/[24px] font-medium font-grotesk text-[#242426]">
          Reject & send message
        </Button>
      </DialogTrigger>
