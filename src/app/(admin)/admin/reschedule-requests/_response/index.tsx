  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button className="w-[113px] h-[36px] py-[10px] px-[40px] rounded-lg gap-2 bg-[#FDFDFD] text-[#242426] text-sm/[16.94px] font-normal font-grotesk flex">
          <CircleArrowDown />
          View
        </Button>
      </PopoverTrigger>
          ...
          <div className="w-full h-full md:h-[108px] pr-4 pl-6 py-4 grid grid-cols-1 gap-2">
            <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="w-full flex flex-col">
                <h4 className="w-full font-normal font-grotesk text-primary text-sm/[18px]">
                  Current Schedule
                </h4>
                <p className="w-full font-medium font-grotesk text-[#242426] text-sm/[18px]">
              ...
              <div className="w-full flex flex-col">
                <h4 className="font-normal font-grotesk text-primary text-sm/[18px]">
                  Requested Week
                </h4>
                <p className="font-medium font-grotesk text-[#242426] text-sm/[18px]">
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6">
              {row.status.toLowerCase() === "accepted" ? null : (
                <div className="w-full flex justify-end items-end">
                  <Button
                    className="bg-[#FFFFFF] border border-solid border-[#BBBFC1] rounded-[4px] px-6 h-[48px] w-[128px] flex justify-center items-center gap-2 text-[#242731] font-medium font-grotesk text-[16px]/[24px]"
