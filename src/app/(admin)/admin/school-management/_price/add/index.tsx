  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="w-[200px] h-[45px] py-[12px] gap-2 font-bold font-grotesk text-[14px]/[24px] md:text-[16px]/[20px] bg-white text-black hover:scale-[1.008] transition duration-300 ease-in-out justify-start rounded-md capitalize">
          <Plus /> Add Price
        </Button>
      </DialogTrigger>

      <DialogContent className="w-full flex flex-col gap-5">
        <DialogTitle className="w-full font-grotesk font-bold text-[19px]/[28px] tracking-[0.2px] text-left text-secondary uppercase">
          Add Price
        </DialogTitle>
