...
const getVideoPoster = (videoUrl: string): string => {
  // Extract first frame: Use so_0 (start offset 0 seconds) to get the first frame
  // Format: /video/upload/so_0/{version}/{public_id}.jpg
  try {
    // Extract first frame (so_0 = start offset 0 seconds) and convert to jpg
...
export function SuccessStories() {
  ...
  return (
    <div className="flex flex-col items-center py-12 sm:py-16 md:py-20 lg:pt-6 xl:pt-8 2xl:pt-10 lg:pb-16 xl:pb-24 2xl:pb-32 w-full px-4 sm:px-6 md:px-8 lg:px-30">
      <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 sm:gap-5 md:gap-20 items-start justify-center w-full max-w-7xl xl:max-w-[90rem] 2xl:max-w-[1440px]">
                    ...
                    >
                      ...
                      <div className="relative rounded-xl sm:rounded-2xl bg-gradient-to-b from-[#242930] to-[#13181f] overflow-hidden pb-3 sm:pb-4">
                        ...
                        <div className="flex flex-col gap-2 sm:gap-3 items-start pt-3 sm:pt-4 px-3 sm:px-4 pb-0 w-full">
                          ...
                          {/* Description */}
                          <div className={`flex flex-col items-start opacity-70 w-full ${!story.hasVideo ? 'min-h-[8rem] sm:min-h-[10rem]' : ''}`}>
                            ...
                            <div className="flex flex-col items-start overflow-hidden relative rounded-xl sm:rounded-2xl w-full sm:w-80 md:w-96 mt-2 sm:mt-3">
                              {playingVideoIndex === index ? (
                                ...
                                <>
                                  ...
                                  <div className="relative w-full aspect-video rounded-xl sm:rounded-2xl overflow-hidden cursor-pointer" onClick={() => handlePlayVideo(index)}>
                                    <video
                                      src={story.videoUrl}
